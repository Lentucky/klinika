...
<body>
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top pt-2 py-4">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <a class="navbar-brand" href="#main"><img src="img/png-icons/logo.png" loading="lazy" class="nav-logo" alt="Allen Logo"></a>
